...
if (isset($_POST["submit"])){
	...
	if(add($_POST)>0){
		echo '<script type="text/Javascript"> alert ("Data berhasil ditambahkan"); window.location.href = "dataBarang.php"</script>';		
	}
	else {
		echo '<script type="text/Javascript"> alert ("Data gagal ditambahkan"); window.location.href = "dataBarang.php"</script>';
	}
}
function add($data){
	global $conn;
...
<html>
<head>
<title> Admin - Tambah data Barang </title>
