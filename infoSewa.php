...
$sewa = query("SELECT * FROM data_sewa WHERE id IN (SELECT MAX(id) FROM data_sewa)");
...
<body>
	...
	<div class="main">
		...
		<div class="tabel">
			...
			<td style="height:100px" width="80px" align="center"><a href="transaksi.php?id=<?php echo $row["id"];?>" class = "editBtn"> Terima </a> <br><br><br>
			<a href="formSewa.php?id=<?php echo $row["id"];?>" onclick="return confirm('Jadwal telah terpakai. Silahkan pilih jadwal lain!');" class = "delBtn"> Tolak </a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; ?>
